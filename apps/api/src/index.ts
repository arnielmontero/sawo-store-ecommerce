...
import { carrierRulesRouter } from "./routes/carrierRules.routes";
import { paymentMethodRulesRouter } from "./routes/paymentMethodRules.routes";
...
app.use("/api/v1/carrier-rules", carrierRulesRouter);
app.use("/api/v1/payment-method-rules", paymentMethodRulesRouter);
